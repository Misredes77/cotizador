  ...
  <center>
    ...
    <div class="btn-container">
        <a href="Cotizar.jsp">
                ...
                <button id="tres" class="btn btn-outline-info" type="button"><i class="bi bi-calculator"></i> Cotizar</button>
       </a>
        </div>
        <div class="btn-container">
            <a href="Responder.jsp">
                <img src="responder.png" alt="Responder">
                <button id="dos" class="btn btn-outline-info" type="button">Responde</button>
        </a>
        </div>
        <div class="btn-container">
            <a href="Crearusuario.jsp">
                <img src="usuario.png" alt="Crear usuario">
                <button id="uno" class="btn btn-outline-info" type="button">Administrador</button>
        </a>
    </div>
        </center>
